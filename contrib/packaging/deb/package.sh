...
NERDCTL_RELEASE="2.2.0"
NERDCTL_COMMIT="4eb4cbdb6b7ae82ab864a9829d1162a20eb61f81"
NERDCTL_SRC=nerdctl-"${NERDCTL_COMMIT}"
NERDCTL_VERSION="v$(echo "$NERDCTL_RELEASE" | sed 's/-.*//')"

# buildkit
BUILDKIT_PACKAGE="github.com/moby/buildkit"
BUILDKIT_RELEASE="0.25.2"
BUILDKIT_COMMIT="dcc0fe5e96ae78919b30057d0804c52f13a2eb7e"
...
SOCI_RELEASE="0.12.0"
SOCI_COMMIT="eef118c6072dc125f0e030089833c4230540929f"
