...
# build aarch64 deb
dpkg-deb --build --root-owner-group ${SCRIPT_DIR}/run-finch_${VERSION}_aarch64
 
# build the amd64 deb
# runfinch-finch_$VERSION}_amd64
dpkg-deb --build --root-owner-group ${SCRIPT_DIR}/run-finch_${VERSION}_amd64
