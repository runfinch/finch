...
ifneq (,$(findstring arm64,$(ARCH)))
	...
	LIMA_URL ?= https://deps.runfinch.com/aarch64/lima-and-qemu.macos-aarch64.1698292683.tar.gz
	...
	LIMA_URL ?= https://deps.runfinch.com/x86-64/lima-and-qemu.macos-x86_64.1698292683.tar.gz
endif
