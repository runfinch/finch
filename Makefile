...
ifneq (,$(findstring arm64,$(ARCH)))
	...
	LIMA_URL ?= https://deps.runfinch.com/aarch64/lima-and-qemu.macos-aarch64.1681169530.tar.gz
	...
	LIMA_URL ?= https://deps.runfinch.com/x86-64/lima-and-qemu.macos-x86_64.1681170025.tar.gz
endif
