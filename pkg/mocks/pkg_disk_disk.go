...
type MockUserDataDiskManager struct {
	...
	recorder *MockUserDataDiskManagerMockRecorder
}
...
func NewMockUserDataDiskManager(ctrl *gomock.Controller) *MockUserDataDiskManager {
	mock := &MockUserDataDiskManager{ctrl: ctrl}
	mock.recorder = &MockUserDataDiskManagerMockRecorder{mock}
	return mock
}
...
func (mr *MockUserDataDiskManagerMockRecorder) EnsureUserDataDisk() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnsureUserDataDisk", reflect.TypeOf((*MockUserDataDiskManager)(nil).EnsureUserDataDisk))
}
